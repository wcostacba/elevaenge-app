...
function ext_rfb_cpf($cpf) {
    ...
    curl_setopt_array($curl, [
        CURLOPT_URL => "https://apicpf.com/api/consulta?cpf=".$cpf."&api_key=".$api_cfg[$api_id]["key"],
    ...
    if($curl_info["http_code"] != "200") {
        ...
        // outros
            ...
            if(empty($msg)) {
                $msg = utf8_encode("A API CPF está indisponível para consulta");
            }
