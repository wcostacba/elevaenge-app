        ...
        <div class="content-wrapper pad_conteudo">
            ...
            <section class="content-header pad_header">
                ...
                <div class="btn_topo_pag">
                    ...
                    <a href="#" class="btn btn-success" data-titulo="Novo cliente" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/pessoa/pessoa_m_adicionar_etapa1.php?form=<?php echo codifica("cliente"); ?>&retornourl=<?php echo codifica($_SERVER["REQUEST_URI"]); ?>" data-modaliframe="2" data-btnok="Avançar">Novo cliente</a>
                </div>
            </section>
                                ...
                                <tbody>
                                    <?php while($res_registro = mysql_fetch_assoc($query_registro)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $res_registro["cargo_nome"]; ?></td>
                                            <td>
                                                <?php
                                                
                                                ?>
                                            </td>
                                            <td class="lgex"><span class="label label-<?php echo $cliente_situacao[$res_registro["situacao"]]["cor"]; ?>"><?php echo $cliente_situacao[$res_registro["situacao"]]["desc"]; ?></span></td>
                                            <td class="lgex">
                                                <div class="text-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a href="#" class="btloading" data-titulo="Editar cliente" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/pessoa/pessoa_m_editar.php?pessoa=<?php echo codifica($res_registro["pessoa_id"]); ?>&form=<?php echo codifica("cliente"); ?>&retornourl=<?php echo codifica($_SERVER["REQUEST_URI"]); ?>" data-modaliframe="2"><i class="fa fa-pencil"></i> Editar cliente</a></li>
                                                            <li><a href="#" class="btloading" data-titulo="Habilitar cliente" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/2026_cliente/cliente_m_habilitar.php?cliente=<?php echo codifica($res_registro["cliente_id"]); ?>" data-modaliframe="1"><i class="fa fa-check"></i> Habilitar cliente</a></li>
                                                            <li><a href="#" class="btloading" data-titulo="Desabilitar cliente" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/2026_cliente/cliente_m_desabilitar.php?cliente=<?php echo codifica($res_registro["cliente_id"]); ?>" data-modaliframe="1"><i class="fa fa-close"></i> Desabilitar cliente</a></li>
