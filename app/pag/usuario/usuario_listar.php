...
// INICIO FILTRO
    ...
    if($filtro_palavra) {
        $_SESSION["GLEURUYFWX_fpalavra"] = codifica($filtro_palavra);
    } else {
        $filtro_palavra = decodifica($_SESSION["GLEURUYFWX_fpalavra"]);
    }
        ...
        <div class="content-wrapper pad_conteudo">
            ...
            <section class="content-header pad_header">
                ...
                <div class="btn_topo_pag">
                    ...
                    <a href="#" class="btn btn-success" data-titulo="Novo usuário" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/pessoa/pessoa_m_adicionar_etapa1.php?form=<?php echo codifica("usuario"); ?>&retornourl=<?php echo codifica($_SERVER["REQUEST_URI"]); ?>" data-modaliframe="2" data-btnok="Avançar">Novo usuário</a>
                </div>
            </section>
                                                ...
                                                <div class="text-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a href="#" class="btloading" data-titulo="Editar usuário" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/pessoa/pessoa_m_editar.php?pessoa=<?php echo codifica($res_registro["pessoa_id"]); ?>&form=<?php echo codifica("usuario"); ?>&retornourl=<?php echo codifica($_SERVER["REQUEST_URI"]); ?>" data-modaliframe="2"><i class="fa fa-pencil"></i> Editar usuário</a></li>
