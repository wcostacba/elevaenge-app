        ...
        <div class="content-wrapper pad_conteudo">
            ...
            <section class="content-header pad_header">
                ...
                <div class="btn_topo_pag">
                    <a href="#" class="btn btn-success" data-titulo="Novo modelo do equipamento" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/equipamento_modelo/equipamento_modelo_m_adicionar.php" data-modaliframe="1" data-tam="pequeno">Novo modelo</a>
                </div>
            </section>
