        ...
        <div class="content-wrapper pad_conteudo">
            ...
            <section class="content-header pad_header">
                ...
                <div class="btn_topo_pag">
                    <a href="#" class="btn btn-success" data-titulo="Novo contrato" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/contrato/contrato_m_adicionar.php" data-modaliframe="1" data-tam="grande">Novo contrato</a>
                </div>
            </section>
