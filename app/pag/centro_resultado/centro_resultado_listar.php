        ...
        <div class="content-wrapper pad_conteudo">
            ...
            <section class="content-header pad_header">
                ...
                <div class="btn_topo_pag">
                    <a href="#" class="btn btn-success" data-titulo="Novo centro de resultado" data-pag="<?php echo $app_cfg["path_raiz"]; ?>/pag/centro_resultado/centro_resultado_m_adicionar.php" data-modaliframe="1" data-tam="pequeno">Novo centro</a>
                </div>
            </section>
